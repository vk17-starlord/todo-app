...
function TaskCardForm({ card = {}, onSave }) {
    ...
    const handleSubmit = (e) => {
        ...
        const createdAt = isNewCard ? new Date().toISOString() : formData.created_at; // Generate current timestamp
    ...
    return (
        <div className="w-full task-form">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="input-container">
                    <label>
                        Tags e.g ( Urgent , Important , Priority ) Make sure it is comma seperated :
                    </label>
                    <input
                        required
                        type="text"
